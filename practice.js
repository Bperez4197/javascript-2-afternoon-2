...
function addTen(numbers){
  ...
  for(i=0;i<numbers.length;i++){
    var newVal1 = parseInt(numbers[i]);
    var newVal = newVal1 + 10;
    newArr.push(newVal);
  }
  return newArr;
}
...
function both(arr1,arr2){
 var newArray = arr1.filter(element => arr2.includes(element));
 return newArray;
}
...
for(i=devMountainEmployees.length -1;i >= 0; i--){
...
var user2 = {name: 'Brad McGinnis',
email: 'tylerm@gmail.com',
password: 'iLoveJavaScript',
username: 'infiniteLoop'};
var user3 = {name: 'Kyle McGinnis',
